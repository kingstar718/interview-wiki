...
日常提效(L2,承接 [AI编程工具](content/AI提效/AI编程工具.md)):

- [ ] `AI辅助编码.md` — 给上下文的方法、小步迭代、先测试后实现;**什么不该让 AI 写**(场景:写代码/改代码)
- [ ] `AI辅助调试排障.md` — 贴堆栈/日志的姿势、让 AI 给假设而不是给结论、二分定位(场景:查bug)
- [ ] `AI辅助测试与评审.md` — 生成边界用例、AI review 的盲区(它看不出业务正确性)(场景:写测试/做评审)
- [ ] `AI辅助文档与设计.md` — 设计文档、API 文档、commit/PR 描述、方案对比(场景:写文档/写方案)
