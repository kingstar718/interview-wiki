...
- [x] 真题样题与解析.md — 综合知识样题 17 道(含答案解析)+ 案例样题 1 道(模型答案)+ 论文题目示例(commit 待提交时补)
- [x] 考前速记卡.md — 计算题公式/法律期限/架构风格特征/质量属性战术/高频易错点/考前三天用法(commit 待提交时补)
- [x] 综合知识·信息系统与数学.md — 系统工程与信息系统基础 + 企业信息化/电子政务商务 + 数学与经济管理(commit 待提交时补)
