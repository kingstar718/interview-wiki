...
- [x] 英语学习质量整改(2026-08-03):基础英语词汇按「职场高频」重构(3066→1010 行,去掉 943 条重复与通用词频表残留,710 词全表唯一);技术听说修 3 处发音硬错误(th 清浊不分、/æ/-/e/ 误归长短元音、重音表两行错误列==正确列);技术英语词汇去真重复 + volatile 释义订正;10 篇首节统一 `## 学习地图`;清 34 处 H3 数字编号;check_index.py 的 C/G/H 扩到英语域(D/E 不扩);首页/README/CLAUDE 补入口与约定
