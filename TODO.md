...
- [x] 专业英语术语表.md — 45 词高频术语表 + 读题技巧(commit 待提交时补)
- [x] 架构核心补 ADL/ABSD 一节(commit 待提交时补)
- [x] 案例分析专题补 嵌入式/通信系统答题要点 + 真题清单行(commit 待提交时补)
- [x] 计算机与软件工程补 嵌入式系统小节(commit 待提交时补)
- [x] 信息安全与可靠性补 可靠性模型小节(commit 待提交时补)
- [x] 论文写作专题补 系统建模(UML)素材提示(commit 待提交时补)
