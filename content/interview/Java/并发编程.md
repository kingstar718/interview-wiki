...
| ThreadLocal | ThreadLocalMap、弱引用 Key | 开放寻址与魔数、expungeStaleEntry 时机、TTL 传递 |
| 线程池 | 核心参数、提交流程、拒绝策略 | execute 三步提交源码、ctl 位运算、Worker 为何不可重入 |
| Semaphore | 许可证、acquire/release | 与 CountDownLatch 的区别 |
...
CompletableFuture 编排见[Java基础](Java基础.md)"CompletableFuture 异步编程"；虚拟线程与 pinning 见[Java现代特性](Java现代特性.md)。
